                                ...
                                <table width="98%">
                                        ...
                                        <td>
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td width="40%">
                                                        <SELECT
                                                                class="form-control" name="country_name" value="{{$user_registration->country_name}}" readonly>
                                    ...
                                    <tr height="40">
                                        ...
                                        <td><input type="text" class="form-control" id="NAME"
                                                   name="user_name" value="{{$user_registration->user_name}}"readonly
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td width="30%">
                                                        ...
                                                        <input class="form-control"
                                                               placeholder="Street "
                                                               id="STREET" name="street"  value="{{$user_registration->street}}" readonly>
                                                    ...
                                                    <td width="30%">
                                                        ...
                                                        <input name="city" class="form-control"
                                                               placeholder="City " id="CITY"  value="{{$user_registration->city}}" readonly>
                                                    ...
                                                    <td width="30%">
                                                        ...
                                                        <input name="state" class="form-control"
                                                               placeholder="State " id="STATE"  value="{{$user_registration->state}}" readonly>
                                                ...
                                                <tr>
                                                    <td width="40%">
                                                        ...
                                                        <input name="passport_no" class="form-control"
                                                               ...
                                                               id="PP_NO"  value="{{$user_registration->passport_no}}" readonly>
                                                    ...
                                                    <td width="40%">
                                                        ...
                                                        <SELECT name="STATUS"
                                                                class="form-control" name="type"  value="{{$user_registration->type}}" readonly>
                                                ...
                                                <tr>
                                                    <td width="40%">
                                                        ...
                                                        <input name="issue_date"
                                                               ...
                                                               id="ISSUE_DATE" value="{{$user_registration->issue_date}}" readonly>
                                                    ...
                                                    <td width="40%">
                                                        ...
                                                        <input name="expiry_date"
                                                               ...
                                                               id="EXPIRE_DATE"  value="{{$user_registration->expiry_date}}" readonly>
